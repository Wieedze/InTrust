...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-CTNWGWSS.js")).default;
    case "de":
    case "de-DE":
      return (await import("./de_DE-P43L3PR7.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-RFN65H63.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-JBX5FS3Q.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-CM2EDAQC.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-GYVCUYRD.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-7ZWSMOOE.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-CGMP6VLZ.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-YCZDTF7X.js")).default;
    case "ms":
    case "ms-MY":
      return (await import("./ms_MY-5LHAYMS7.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-3JTS4PSK.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-6J6XERHI.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-STXOD4CR.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-P7QAUUZU.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-JTTBGJGQ.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-5XUUAVWW.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-RGMLPFEP.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-YM3T6EI5.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-HAEH6VE5.js")).default;
    default:
      return (await import("./en_US-RFN65H63.js")).default;
  }
};
